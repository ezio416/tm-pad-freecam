...
void Render() {
    ...
    if (Math::Abs(Pad.LeftStickX) > deadzone) {
        Cam.m_FreeVal_Loc_Translation.x += Pad.LeftStickX * speedNormForFps * Math::Sin(Cam.m_Yaw - halfPi);
        Cam.m_FreeVal_Loc_Translation.z += Pad.LeftStickX * speedNormForFps * Math::Cos(Cam.m_Yaw - halfPi);
    }

    if (Math::Abs(Pad.LeftStickY) > deadzone) {
        Cam.m_FreeVal_Loc_Translation.x -= Pad.LeftStickY * speedNormForFps * Math::Sin(Cam.m_Yaw) * cosPitch;
        Cam.m_FreeVal_Loc_Translation.y -= Pad.LeftStickY * speedNormForFps * -Math::Sin(Cam.m_Pitch);
        Cam.m_FreeVal_Loc_Translation.z -= Pad.LeftStickY * speedNormForFps * Math::Cos(Cam.m_Yaw) * cosPitch;
    }
}
